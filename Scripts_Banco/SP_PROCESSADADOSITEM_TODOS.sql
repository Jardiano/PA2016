	     ...
	     DECLARE 
			...
			CURSOR LISTA IS (SELECT ITEM,NOMEITEM,QTDTOTCLIENTEMES,TOTALCLIENTE,VARIACAOCLI,TOTALFATURAMENTO,VARIACAOFAT,
							...
							(SELECT SUM (B.QUANTCLIENTE) FROM CARGA_DADOS B WHERE A.ITEM_IDITEM = B.ITEM_IDITEM 
							 AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)) AS TOTALCLIENTE,
							...
							AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)))*100),2) AS VARIACAOCLI,
							...
							AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)) AS TOTALFATURAMENTO,
							TRUNC(((SUM(A.QUANTFATURAMENTO)/(SELECT SUM (B.QUANTFATURAMENTO) FROM CARGA_DADOS B WHERE A.ITEM_IDITEM = B.ITEM_IDITEM
							AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)))*100),2) AS VARIACAOFAT,
							TRUNC(((((SELECT MAX(VARIACAO) FROM (SELECT A.ITEM_IDITEM AS ITEM,
							TRUNC(((SUM(A.QUANTCLIENTE)/(SELECT SUM (B.QUANTCLIENTE) FROM CARGA_DADOS B WHERE A.ITEM_IDITEM = B.ITEM_IDITEM 
							AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)))*100),2) AS VARIACAO
							FROM CARGA_DADOS A
							...
							*
							...
							AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-6),'MONTH') AS DIA FROM CARGA_DADOS)))*100),2) AS VARIACAO  
							FROM CARGA_DADOS D
							...
							*
							...
							WHERE A.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)							 
		...
		CURSOR LISTA02 IS (SELECT ITEM,NOMEITEM,QTDTOTCLIENTEMES,TOTALCLIENTE,VARIACAOCLI,TOTALFATURAMENTO,VARIACAOFAT,
						   ...
						   CENARIOPESSIMISTAFATURAMENTO,VOLUMEPROVAVELFAT,VOLUMEPROVAVELCLI FROM
							(SELECT
								...
								(SELECT SUM (B.QUANTCLIENTE) FROM CARGA_DADOS B WHERE A.ITEM_IDITEM = B.ITEM_IDITEM 
									AND B.DT_REALIZADA >= (SELECT TRUNC(ADD_MONTHS(MAX(DT_REALIZADA),-VALORPARAMETRO),'MONTH') AS DIA FROM CARGA_DADOS)
