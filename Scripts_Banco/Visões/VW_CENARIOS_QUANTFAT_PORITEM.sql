CREATE OR REPLACE VIEW VW_CENARIOS_QUANTFAT_PORITEM
   AS
      SELECT 
          A.ID_ITEM AS ID_ITEM,A.NOME_ITEM AS NM_ITEM,
          A.CENARIOTIMISTAFATURAMENTO AS CENARIOOTIMISTA_CLI,
          A.CENARIOPESSIMISTAFATURAMENTO AS CENARIOPESSIMISTA_CLI,
          A.CENARIOPROVAVELFAT AS CENARIOPROVAVEL_CLI,
